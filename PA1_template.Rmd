...
*Average number of steps per day is changed from `r format(avgStepsPerDay)` to `r format(avgStepsPerDay_Full)`.*  
*Median number of steps per day is changed from `r format(medStepsPerDay)` to `r format(medStepsPerDay_Full)`.*  
*Difference of mean before and after imputing: `r format(diffAvg)`.*  
*Difference of median before and after imputing: `r format(diffMed)`.* 
